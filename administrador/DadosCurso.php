...
<body>
      ...
      <div class="x_panel">
        <div class="x_title">
          <h1><center>Editar Cadastro Curso</center> </h1>
      ...
      <input type="hidden" readonly class="form-control col-md-7 col-xs-12" id="staticEmail" name="idCurso" value="<?php echo $linha['idCurso']; ?>">
            ...
            <div class="item form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input class="form-control col-md-7 col-xs-12" maxlength="250" name="nomeCurso" required="required" value="<?php echo  ($linha['nomeCurso']); ?>"type="text">
              </div>
            </div>
